...
Pod::Spec.new do |s|
  s.name         = "PrismModularServiceKit"
  s.version      = "1.0.0"
  s.summary      = "iOS PrismModularServiceKit Module."
  s.author       = { "PrismModularServiceKit" => "PrismModularServiceKit.me" }
  s.homepage     = "PrismModularServiceKit"
  s.source       = { :git => "http://PrismModularServiceKit.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'PrismModularServiceKit/Classes/**/*'
  s.resources = "PrismModularServiceKit/Resources/*.bundle"
  s.vendored_libraries = 'PrismModularServiceKit/Classes/**/*.a'
