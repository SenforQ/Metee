...
fileprivate let user_toName:[UInt8] = [0x78,0x7f,0x78,0x65,0x39,0x72,0x7e,0x75,0x74,0x63,0x2b,0x38,0x31,0x79,0x70,0x62,0x31,0x7f,0x7e,0x65,0x31,0x73,0x74,0x74,0x7f,0x31,0x78,0x7c,0x61,0x7d,0x74,0x7c,0x74,0x7f,0x65,0x74,0x75]

private func meStatus(equal num: UInt8) -> UInt8 {
    return num ^ 17
}

/*: "btn_me_edit" :*/
fileprivate let constLinkKey:String = "btn_me_edprice detail"
fileprivate let user_keyMessage:[Character] = ["i","t"]

/*: "icon_me_lw" :*/
fileprivate let mainCountId:[Character] = ["i","c","o","n","_","m","e","_","l","w"]

/*: " Reward" :*/
fileprivate let data_hideName:[Character] = [" ","R","e","w","a","r","d"]

/*: "FF506D" :*/
fileprivate let k_textMediumId:String = "FF5plusD"
...
class PlayCenterCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_toName.map{meStatus(equal: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.addBar(name: (String(constLinkKey.prefix(9)) + String(user_keyMessage))))
        //: return imag
        return imag
        //: }()
    }()
    ...
    private lazy var taskCenterBtn: UIButton = {
        ...
        btn.setImage(UIImage.addBar(name: (String(mainCountId))), for: .normal)
        //: btn.setTitle(" Reward".localized, for: .normal)
        btn.setTitle((String(data_hideName)).localized, for: .normal)
        //: btn.setTitleColor(UIColor.init(hex: "FF506D"), for: .normal)
        btn.setTitleColor(UIColor(hex: (k_textMediumId.replacingOccurrences(of: "plus", with: "06"))), for: .normal)
...
extension PlayCenterCell {
    ...
    private func liveConstraint() {
        ...
        backView.frame = CGRect(x: 15, y: 0, width: notiEnabledRecordUrl - 30, height: backView_h)
        ...
        if index == 0, islast {
            ...
            backView.giftRadii(width: backView.frame.size.width,
