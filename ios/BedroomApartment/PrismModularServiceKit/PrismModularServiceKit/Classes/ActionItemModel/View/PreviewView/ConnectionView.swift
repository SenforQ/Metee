...
fileprivate let constMediumVideoPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_male_default" :*/
fileprivate let showViewStr:[UInt8] = [0xd2,0xd8,0xd4,0xd5,0xe4,0xd6,0xda,0xd7,0xde,0xe4,0xdf,0xde,0xdd,0xda,0xce,0xd7,0xcf]

/*: "icon_female_default" :*/
fileprivate let showStateName:String = "view event error modelicon_f"
fileprivate let notiMakeData:String = "model case make vare_def"

/*: "level_%@" :*/
fileprivate let mainTimeMessage:[Character] = ["l","e","v","e","l","_"]
fileprivate let k_titleIndexAcceptMsg:String = "fill@"
...
class ConnectionView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constMediumVideoPath.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var headerPic = UIImageView().then {
        ...
        $0.image = UIImage.quadrateComment()
    ...
    lazy var nickLabel = UILabel().then {
        ...
        $0.font = .pingfangCenter(type: .Medium, fontSize: 17)
        //: $0.textColor = .white
        $0.textColor = .white
    }
    ...
    lazy var ageLabel = UILabel().then {
        ...
        $0.font = .pingfangCenter(type: .Regular, fontSize: 10)
        //: $0.textColor = .white
        $0.textColor = .white
    }
...
extension ConnectionView {
    ...
    func labBy(model: InfoLogTransformable) {
        //: headerPic.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.placeImgSquare())
        headerPic.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.quadrateComment())
        ...
        let imgStr = model.sex == ScoreScalarLiteral.male.rawValue ? String(bytes: showViewStr.map{$0^187}, encoding: .utf8)! : (String(showStateName.suffix(6)) + "emal" + String(notiMakeData.suffix(5)) + "ault")
        //: sexImgView.image = UIImage(named: imgStr)
        sexImgView.image = UIImage(named: imgStr)
        //: let levelStr = String(format: "level_%@", model.level)
        let levelStr = String(format: (String(mainTimeMessage) + k_titleIndexAcceptMsg.replacingOccurrences(of: "fill", with: "%")), model.level)
