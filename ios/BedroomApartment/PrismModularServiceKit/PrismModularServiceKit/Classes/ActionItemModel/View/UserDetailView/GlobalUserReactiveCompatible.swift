...
fileprivate let mainFacePath:[UInt8] = [0xbb,0xc0,0xbb,0xc6,0x7a,0xb5,0xc1,0xb6,0xb7,0xc4,0x8c,0x7b,0x72,0xba,0xb3,0xc5,0x72,0xc0,0xc1,0xc6,0x72,0xb4,0xb7,0xb7,0xc0,0x72,0xbb,0xbf,0xc2,0xbe,0xb7,0xbf,0xb7,0xc0,0xc6,0xb7,0xb6]

fileprivate func userView(section num: UInt8) -> UInt8 {
...
fileprivate let mainMakeMessage:[Character] = ["b","t","n","_","d","y","n","a","m","i","c","_","s","t","o","p","_"]
fileprivate let show_listenStr:String = "NOR"
...
// __CLOSE_PRINT__
//
//  GlobalUserReactiveCompatible.swift
//  AbroadTalking
//
...
class GlobalUserReactiveCompatible: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainFacePath.map{userView(section: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var playimageView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.addBar(name: (String(mainMakeMessage) + show_listenStr.lowercased())))
        //: return imag
        return imag
        //: }()
    }()
...
extension GlobalUserReactiveCompatible {
    //: func configModel(videoUrl: String, imgUrl: String ) {
    func toTing(videoUrl: String, imgUrl: String) {
        //: self.videoUrl = videoUrl
        self.videoUrl = videoUrl
        //: self.coverView.setUrlImage(urlStr: imgUrl)
        self.coverView.step(urlStr: imgUrl)
    }
    ...
    func errorPlayer() {
        ...
        self.player.trademark(url: videoUrl, view: self.coverView)
...
extension GlobalUserReactiveCompatible: ShareTalkingPlayerDelegate {
