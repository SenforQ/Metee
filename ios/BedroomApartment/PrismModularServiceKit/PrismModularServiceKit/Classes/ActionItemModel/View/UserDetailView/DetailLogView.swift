...
fileprivate let userToText:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_gift_placeholder" :*/
fileprivate let showItemContent:[Character] = ["i","c","o","n","_","g","i"]
fileprivate let k_fillLeadingStr:String = "fwhite"
fileprivate let data_humanStr:String = "_placname title cell make back"

/*: "Gift" :*/
fileprivate let constErrorKey:[Character] = ["G","i","f","t"]

/*: "x%ld" :*/
fileprivate let k_valueName:String = "true tox%ld"
...
class DetailLogView: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        self.textSubConstraint()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: userToText.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .appearToRgba(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.addBar(name: (String(showItemContent) + k_fillLeadingStr.replacingOccurrences(of: "white", with: "t") + String(data_humanStr.prefix(5)) + "eholder"))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(constErrorKey)).localized
...
extension DetailLogView {
    ...
    func marginOfSafety(giftModel: VampirismModelPossibilityHandyJSON, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.step(urlStr: giftModel.img)
...
extension DetailLogView {
    ...
    private func textSubConstraint() {
