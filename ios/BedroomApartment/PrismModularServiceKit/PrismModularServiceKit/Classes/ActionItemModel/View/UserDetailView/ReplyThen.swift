...
fileprivate let constTapMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Gifts received" :*/
fileprivate let appPriceContent:String = "model party head textGifts "
...
class ReplyThen: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.quantityerchangeWindow()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: constTapMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(appPriceContent.suffix(6)) + "received").localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(DetailLogView.self, forCellWithReuseIdentifier: DetailLogView.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension ReplyThen: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: DetailLogView.className(), for: indexPath) as! DetailLogView
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: VampirismModelPossibilityHandyJSON = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.marginOfSafety(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
...
extension ReplyThen {
    ...
    private func quantityerchangeWindow() {
