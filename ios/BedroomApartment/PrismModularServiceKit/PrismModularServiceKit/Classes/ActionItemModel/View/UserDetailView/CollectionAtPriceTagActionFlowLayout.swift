...
// __CLOSE_PRINT__
//
//  CollectionAtPriceTagActionFlowLayout.swift
//  AbroadTalking
//
...
protocol KeyLayoutDelegate: NSObjectProtocol {
...
class CollectionAtPriceTagActionFlowLayout: UICollectionViewFlowLayout {
    //: var delegate: TalkingTagCollectionFlowLayoutDelegate?
    var delegate: KeyLayoutDelegate?
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for i in 1..<attributes.count {
            ...
            if i == attributes.count-1 {
                ...
                self.delegate?.deadline(layoutH: curAttr.frame.maxY)
            }
        }
