...
fileprivate let mainBottomMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "StatuteTitleReusableView" :*/
fileprivate let data_groupUpUrl:[Character] = ["T","a","l","k","i","n","g","T","a","g","C","e","l","l"]
...
typealias DeleteTagBlock = (ViewTransformable) -> Void

//: class TalkingTagView: UIView {
class TrackThen: UIView {
    //: var deleteBlock: DeleteTagBlock!
    var deleteBlock: DeleteTagBlock!
    //: var titles = [UserSeleteTagModel]()
    var titles = [ViewTransformable]()
    //: var tagContentAlignment = TagContentAlignment.left {
    var tagContentAlignment = ToTextAlignment.left {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainBottomMsg.reversed(), encoding: .utf8)!)
    }
...
extension TrackThen: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: (String(data_groupUpUrl)), for: indexPath) as! StatuteTitleReusableView
...
extension TrackThen: CostThen {
    ...
    func moreLive(_: AddViewLayout, collectionView _: UICollectionView, sizeForSupplementaryElementOfKind _: String, at _: Int) -> CGSize {
...
extension TrackThen {
    ...
    func colorFrame(frame _: CGRect) {
        //: collectionView.frame = self.bounds
        collectionView.frame = self.bounds
        //: collectionView.backgroundColor = .white
        collectionView.backgroundColor = .white
        //: collectionView.register(TalkingTagCell.self, forCellWithReuseIdentifier: "TalkingTagCell")
        collectionView.register(StatuteTitleReusableView.self, forCellWithReuseIdentifier: (String(data_groupUpUrl)))
