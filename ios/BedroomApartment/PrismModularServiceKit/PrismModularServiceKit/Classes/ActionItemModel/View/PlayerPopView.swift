...
fileprivate let k_collectionName:[UInt8] = [0xae,0xa9,0xae,0xb3,0xef,0xa4,0xa8,0xa3,0xa2,0xb5,0xfd,0xee,0xe7,0xaf,0xa6,0xb4,0xe7,0xa9,0xa8,0xb3,0xe7,0xa5,0xa2,0xa2,0xa9,0xe7,0xae,0xaa,0xb7,0xab,0xa2,0xaa,0xa2,0xa9,0xb3,0xa2,0xa3]

private func mAcross(make num: UInt8) -> UInt8 {
    return num ^ 199
}

/*: "icon_faceverification_guide_ok" :*/
fileprivate let user_myGiftMessageMsg:[Character] = ["i"]
fileprivate let user_resultId:[Character] = ["c","o","n","_","f","a","c","e","v","e","r","i","f","i","c","a","t","i","o","n","_","g","u","i","d","e","_","o","k"]

/*: "Submitted successfully, please wait \n patiently for review." :*/
fileprivate let show_makeBackUrl:[UInt8] = [0x2e,0x77,0x65,0x69,0x76,0x65,0x72,0x20,0x72,0x6f,0x66,0x20,0x79,0x6c,0x74,0x6e,0x65,0x69,0x74,0x61,0x70,0x20,0xa,0x20,0x74,0x69,0x61,0x77,0x20,0x65,0x73,0x61,0x65,0x6c,0x70,0x20,0x2c,0x79,0x6c,0x6c,0x75,0x66,0x73,0x73,0x65,0x63,0x63,0x75,0x73,0x20,0x64,0x65,0x74,0x74,0x69,0x6d,0x62,0x75,0x53]
...
class PlayerPopView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_collectionName.map{mAcross(make: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var successIconView: UIImageView = {
        ...
        imgView.image = UIImage.addBar(name: (String(user_myGiftMessageMsg) + String(user_resultId)))
        //: return imgView
        return imgView
        //: }()
    }()
    ...
    lazy var tipLab: UILabel = {
        ...
        lb.text = String(bytes: show_makeBackUrl.reversed(), encoding: .utf8)!.localized
