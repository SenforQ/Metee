...
/*: "id" :*/
fileprivate let constCurrentTitle:String = "isend"
...
struct AddModelType: HandyJSON {
    ...
    var momentPic: BondMomentModel?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [PopModelType]? // 相册
    ...
    var aiExtraInfo = SimulationTransformable() // AI模型
    //: var vipSkinId = 0
...
struct BondMomentModel: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [ScoreShareModelType]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct ScoreShareModelType: HandyJSON {
...
struct PopModelType: HandyJSON {
    ...
    func custom(compareTo: PopModelType) -> Bool {
        //: return
        return
