...
/*: "detection" :*/
fileprivate let user_infoFormat:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let dataSectionStr:[Character] = ["a","i","f","f"]
...
class ClickControlThen: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = ClickControlThen()
    ...
    func itemSlide() {
        ...
        let soundFilePath = ShadowEffectTool.default.toType(name: (String(user_infoFormat)), type: (String(dataSectionStr)))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            ClickControlThen.shared.judgeRequestComplete()
        }
