...
fileprivate let userBottomGiftImageFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Enter phone number" :*/
fileprivate let appEmptyViewPath:[Character] = ["E","n","t","e","r"," ","p","h"]
fileprivate let dataAwakeUrl:String = "one title to if"

/*: "Enter Email Address" :*/
fileprivate let k_downTitle:String = "log class center to falseEnte"
fileprivate let userAttributeFormat:String = "selection inneril A"
fileprivate let const_ofKey:[Character] = ["d","d","r","e","s","s"]

/*: "F4F4F4" :*/
fileprivate let k_groupId:[Character] = ["F","4","F","4","F","4"]

/*: "America(+1)" :*/
fileprivate let userMakeTitle:String = "Americtrue return"
fileprivate let userStyleUrl:[Character] = ["a","(","+","1",")"]

/*: "area_code_down_icon" :*/
fileprivate let data_toInfoFormat:String = "medium pointarea_"
fileprivate let kFlushValue:String = "screen let returncode_"
fileprivate let main_selectedStr:[Character] = ["d","o","w","n","_","i","c","o","n"]

/*: "BBBBBB" :*/
fileprivate let noti_keyTitle:[Character] = ["B","B","B","B","B","B"]

/*: "btn_field_delete_icon" :*/
fileprivate let showActionUrl:String = "btool"
fileprivate let dataIndexPath:String = "n_fieladd if height source"
fileprivate let const_curName:String = "input table guard count trueete_"

/*: "Password" :*/
fileprivate let notiBuildData:[Character] = ["P","a","s","s","w","o"]
fileprivate let constScaleMessage:[Character] = ["r","d"]

/*: "CCCCCC" :*/
fileprivate let main_choiceKey:String = "filefilefile"

/*: "or" :*/
fileprivate let userMeId:String = "cellr"

/*: "F5F5F5" :*/
fileprivate let dataCloudViewStr:[Character] = ["F","5","F","5","F"]
fileprivate let noti_succeedKey:[Character] = ["5"]

/*: "Next" :*/
fileprivate let k_itemPath:String = "data size viewNext"

/*: "Login by password" :*/
fileprivate let mainViewUrl:String = "in for viewLogi"
fileprivate let data_nameUrl:String = "assbackground"
fileprivate let app_toTitle:String = "orpop"

/*: "Login by OTP" :*/
fileprivate let notiValueMessage:[Character] = ["L","o","g","i","n"," ","b","y"," ","O","T","P"]

/*: "#8C7AFF" :*/
fileprivate let appLayerValue:String = "var add if message#8C7AFF"

/*: "Login" :*/
fileprivate let const_labValue:String = "Loginfalse error path disappear"

/*: "Send verification" :*/
fileprivate let showEqualTitle:[Character] = ["S","e","n","d"," ","v","e","r","i","f","i","c"]
fileprivate let showMagnitudeimateUrl:[Character] = ["a","t","i","o","n"]
...
class ColorFieldDelegate: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userBottomGiftImageFormat.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(appEmptyViewPath) + String(dataAwakeUrl.prefix(4)) + "number").localized : (String(k_downTitle.suffix(4)) + "r Ema" + String(userAttributeFormat.suffix(4)) + String(const_ofKey)).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (String(k_groupId)))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(userMakeTitle.prefix(6)) + String(userStyleUrl))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.addBar(name: (String(data_toInfoFormat.suffix(5)) + String(kFlushValue.suffix(5)) + String(main_selectedStr)))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (String(k_groupId)))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.pingfangCenter(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (String(noti_keyTitle)))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.addBar(name: (showActionUrl.replacingOccurrences(of: "tool", with: "t") + String(dataIndexPath.prefix(6)) + "d_del" + String(const_curName.suffix(4)) + "icon")), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(notiBuildData) + String(constScaleMessage)).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (main_choiceKey.replacingOccurrences(of: "file", with: "CC")))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(dataCloudViewStr) + String(noti_succeedKey)))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(k_itemPath.suffix(4))).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.outsideBecomeColor(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(mainViewUrl.suffix(4)) + "n by p" + data_nameUrl.replacingOccurrences(of: "background", with: "w") + app_toTitle.replacingOccurrences(of: "pop", with: "d")).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(notiValueMessage)).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(onSender(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(appLayerValue.suffix(7))))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension ColorFieldDelegate {
    ...
    @objc private func onSender(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(const_labValue.prefix(5))).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(k_itemPath.suffix(4))).localized, for: .normal)
        }
    ...
    func original() {
        ...
        commitButton.setTitle((String(showEqualTitle) + String(showMagnitudeimateUrl)).localized, for: .normal)
    }
}
