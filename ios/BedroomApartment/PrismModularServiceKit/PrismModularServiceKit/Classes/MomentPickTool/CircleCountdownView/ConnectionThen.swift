...
fileprivate let data_toViewKey:[UInt8] = [0xc8,0xcf,0xc8,0xd5,0x89,0xc2,0xce,0xc5,0xc4,0xd3,0x9b,0x88,0x81,0xc9,0xc0,0xd2,0x81,0xcf,0xce,0xd5,0x81,0xc3,0xc4,0xc4,0xcf,0x81,0xc8,0xcc,0xd1,0xcd,0xc4,0xcc,0xc4,0xcf,0xd5,0xc4,0xc5]

private func giftModel(comment num: UInt8) -> UInt8 {
    return num ^ 161
}
...
let const_successText = 3.0

//: class CircleCountdownView: UIView {
class ConnectionThen: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.oversee() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_toViewKey.map{giftModel(comment: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.pingfangCenter(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: const_successText / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: const_successText / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - const_successText,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - const_successText)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.oversee().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = const_successText
...
extension ConnectionThen {
    ...
    func imageBy(totalTime: Int, currTime: Int) {
