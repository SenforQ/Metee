...
@objcMembers open class AddBeautyThen: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = AddBeautyThen()
    //: private(set) var currLanguage: String = ColorDelimitateMacroDefine.getSystemLangCode()
    private(set) var currLanguage: String = ColorDelimitateMacroDefine.lang()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func clickAction(_ language: String) {
...
public extension NSString {
    ...
    @objc func pointOfReference() -> String {
...
extension String {
    ...
    public func fast(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = ShadowEffectTool.default.languagePath
