...
/*: / :*/
fileprivate let kBottomKey:String = "/"

/*: "\n" :*/
fileprivate let const_textStr:[Character] = ["\n"]
...
// __CLOSE_PRINT__
//
//  FromScoreViewDelegate.swift
//  FromScoreViewDelegate
...
class FromScoreViewDelegate: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        imageCell(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        imageCell(placeholder: nil, placeholderColor: nil)
    }
}
...
extension FromScoreViewDelegate {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func imageCell(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(CheckLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(CheckLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-CheckLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: ColorContainerInset().top, left: ColorContainerInset().left, bottom: ColorContainerInset().bottom, right: ColorContainerInset().right)
...
extension FromScoreViewDelegate: UITextViewDelegate {
