...
/*: "App" :*/
fileprivate let user_sessionMsg:String = "Appif return text var"

/*: "blockList_ :*/
fileprivate let userStatusKey:String = "remove"
fileprivate let data_appTableCommentMessage:[Character] = ["l","o","c","k","L","i","s","t","_"]
...
// __CLOSE_PRINT__
//
//  WinteriseReactiveCompatible.swift
//  AbroadTalking
//
...
class WinteriseReactiveCompatible: NSObject {
    //: var blockList: [String]?
    var blockList: [String]? // 拉黑列表

    // singleton
    //: static let shared = TalkingBlockListManager()
    static let shared = WinteriseReactiveCompatible()
    ...
    func dropLikeFace(userId: String) {
    ...
    func modeData(userId: String) -> Bool {
    ...
    private func plunge() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(user_sessionMsg.prefix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((userStatusKey.replacingOccurrences(of: "remove", with: "b") + String(data_appTableCommentMessage)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
