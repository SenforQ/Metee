...
/*: "id" :*/
fileprivate let k_fillTitle:[Character] = ["i","d"]
...
struct ModelHeadTransformable: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct BeautyGiftHandyJSON: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct ViewVideoModelType: HandyJSON {
