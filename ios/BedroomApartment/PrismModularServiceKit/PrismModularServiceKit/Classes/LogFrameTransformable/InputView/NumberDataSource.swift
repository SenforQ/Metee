...
fileprivate let data_destroyId:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#292929" :*/
fileprivate let noti_inputFormat:String = "#transform9transform9transform9"

/*: "9999999" :*/
fileprivate let k_recordingUrl:[Character] = ["9","9","9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let data_addName:String = "iitem"
fileprivate let app_touchData:String = "on_coinsuper feature make if add"

/*: "icon_gift_more_arrow" :*/
fileprivate let k_sizeStr:String = "icarrayn"
fileprivate let app_lowerPathMessage:[Character] = ["m","o","r","e","_","a","r","r","o","w"]

/*: "TantamountView" :*/
fileprivate let dataNamePath:[Character] = ["T","a","l","k","i","n","g","P","a","c","k","a","g","e","G","i","f","t","C","e","l","l"]

/*: "Hot" :*/
fileprivate let data_sizeFormat:String = "Hotin user self"

/*: "VIP" :*/
fileprivate let notiVisibleKey:[Character] = ["V","I","P"]

/*: "Bags" :*/
fileprivate let noti_modelValue:String = "log return outside ifBags"

/*: "icon_gift_num_arrow" :*/
fileprivate let show_popStr:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u","m","_","a","r","r","o"]
fileprivate let noti_appKey:String = "make"

/*: "Send" :*/
fileprivate let dataBackgroundPartyName:[Character] = ["S","e","n","d"]

/*: "nav_back_black_nor" :*/
fileprivate let notiViewNorPath:String = "with interaction server self bottomnav_b"
fileprivate let app_mKey:String = "k_nortype of height game define"

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let appFilterContent:[UInt8] = [0x21,0x1d,0x10,0x55,0x1b,0x0,0x18,0x17,0x10,0x7,0x55,0x1a,0x13,0x55,0x12,0x1c,0x13,0x1,0x6,0x55,0x16,0x14,0x1b,0x1b,0x1a,0x1,0x55,0x17,0x10,0x55,0x19,0x10,0x6,0x6,0x55,0x1,0x1d,0x14,0x1b,0x55,0x44]

private func socialAdd(single num: UInt8) -> UInt8 {
    return num ^ 117
}

/*: "Please select a gift" :*/
fileprivate let userBirthdayText:[Character] = ["P","l","e","a","s"]
fileprivate let main_viewName:String = "video to agree direction colore se"
fileprivate let notiSucceedName:[Character] = ["a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let const_valueCornerData:String = "style if tapPlea"
fileprivate let dataRankName:String = "elelayert"
fileprivate let show_equalId:[Character] = ["b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let user_touchTitle:[UInt8] = [0x6b,0x63,0x6f,0x6c,0x6e,0x75,0x20,0x6f,0x74,0x20,0x74,0x66,0x69,0x67,0x20,0x64,0x65,0x72,0x69,0x73,0x65,0x64,0x20,0x65,0x68,0x74,0x20,0x74,0x63,0x65,0x6c,0x65,0x53]

/*: "OK" :*/
fileprivate let notiLayerMsg:String = "Oerror"

/*: "Select object >" :*/
fileprivate let kSizeText:String = "Selecterror m add pic to"
fileprivate let showFrameName:String = "t >title item"

/*: "It looks like there's nothing" :*/
fileprivate let main_userKey:[Character] = ["I","t"," ","l","o","o","k","s"," ","l","i","k","e"," ","t"]
fileprivate let dataKitMakeContent:[Character] = ["h"]
fileprivate let const_theIndexName:[Character] = ["e","r","e","\'","s"," ","n","o","t","h","i","n","g"]

/*: "FF75A4" :*/
fileprivate let user_fillBottomName:String = "FF7colorA4"

/*: "E570FF" :*/
fileprivate let constAppName:String = "E570viewview"

/*: "Ask for" :*/
fileprivate let dataNameCenterMsg:String = "succeed face to count selfAsk for"

/*: " Select %@ > " :*/
fileprivate let appModelPath:[Character] = [" ","S","e"]
fileprivate let noti_sessionMsg:String = "messagect"

/*: "All Numbers" :*/
fileprivate let showHomeId:[Character] = ["A","l"]
fileprivate let const_cameraFormat:[Character] = ["l"," ","N","u","m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let appPlayerFormat:String = "View border connection manager"
fileprivate let app_fileTitle:String = "ated"
fileprivate let userPopMessage:String = "cdatapt"
fileprivate let const_requestOffMsg:String = "ion >height equal name"

/*: "\n" :*/
fileprivate let notiToValue:String = "\n"

/*: "%.2f" :*/
fileprivate let user_layerKey:[Character] = ["%",".","2","f"]

/*: "9999" :*/
fileprivate let show_nameContent:String = "9999"

/*: "Custom" :*/
fileprivate let show_colorAspectPageId:String = "Custoto indicator"
fileprivate let dataGirlPath:String = "head"

/*: "mf_coin" :*/
fileprivate let app_tingStr:[Character] = ["m","f","_","c","o","i","n"]

/*: "showBagsRed" :*/
fileprivate let constFrameMessage:String = "white for link sessionshowBags"
fileprivate let show_pathUrl:String = "view model manager if equalRed"
...
enum FromWeltanschauungContentConvertible: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
typealias SendFunctionBlock = (_ giftModel: ModelHeadTransformable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: ModelHeadTransformable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: ModelHeadTransformable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: ModelHeadTransformable, _ num: String, _ model: ResistanceReactiveCompatible) -> Void
// 隐藏礼物面板Block
...
private let kNetPath = 44.0
//: let GiftScrollContentView_H = 252.0
let data_useMessage = 252.0
//: private let pageControl_H = 7.0
private let constWarnMessage = 7.0
//: private let bottomView_H = 44.0
private let user_lineId = 44.0

//: class TalkingChatGiftView: UIView {
class NumberDataSource: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = kNetPath + data_useMessage + constWarnMessage + user_lineId + constNameValue
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var style: FromWeltanschauungContentConvertible = .normal
    //: var giftSelectedModel = TalkingGiftSelectedModel()
    var giftSelectedModel = ViewVideoModelType()
    //: var chatRoomgiftSelectedMemberModel: TalkingChatRoomMemberModel?
    var chatRoomgiftSelectedMemberModel: ResistanceReactiveCompatible?
    //: var popView: TalkingPopView?
    var popView: PathRecognizerDelegate?
    //: var meneView = DropDownMemberMenuView()
    var meneView = SprechgesangThen()
    ...
    private var titlesArr = [MinutiaRepresentable]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = MinutiaRepresentable.Hot
    ...
    init(frame: CGRect = .zero, style: FromWeltanschauungContentConvertible = .normal, titlesArr: [MinutiaRepresentable] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_destroyId.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: main_versionEnterTimeStr, width: notiEnabledRecordUrl, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (noti_inputFormat.replacingOccurrences(of: "transform", with: "2")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.giftRadii(width: notiEnabledRecordUrl, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: LittlenessGiftView = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: notiEnabledRecordUrl, height: main_partyUrl)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = LittlenessGiftView(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: notiEnabledRecordUrl, height: kNetPath)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (noti_inputFormat.replacingOccurrences(of: "transform", with: "2")))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: QuantityervalFirstButton = {
        //: let btn = TalkingButton()
        let btn = QuantityervalFirstButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.pingfangCenter(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((String(k_recordingUrl)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.addBar(name: (data_addName.replacingOccurrences(of: "item", with: "c") + String(app_touchData.prefix(7)))), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(themeBy), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.addBar(name: (k_sizeStr.replacingOccurrences(of: "array", with: "o") + "_gift_" + String(app_lowerPathMessage)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.appearToRgba(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.appearToRgba(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(TantamountView.self, forCellWithReuseIdentifier: (String(dataNamePath)))
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: TrifleFlowLayout = //: return hotGiftCollectionView.collectionViewLayout as! TrifleFlowLayout
        hotGiftCollectionView.collectionViewLayout as! TrifleFlowLayout
    //: }()
    ...
    private lazy var titleScrollView: StandInThen = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(data_sizeFormat.prefix(3))).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((String(notiVisibleKey)).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(noti_modelValue.suffix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = ControlSegmentStyle()
        ...
        let scrollview = StandInThen(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(kNetPath)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if AddBeautyThen.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = ColorDelimitateMacroDefine.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = ColorDelimitateMacroDefine.memberDisappear() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !ControlGiftManager.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var giftNumButton: QuantityervalFirstButton = {
        ...
        btn.setImage(UIImage.addBar(name: (String(show_popStr) + noti_appKey.replacingOccurrences(of: "make", with: "w"))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(combineClick), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.pingfangCenter(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.outsideBecomeColor()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(dataBackgroundPartyName)).localized, for: .normal)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: main_versionEnterTimeStr - CGFloat(keyborHeight) - 44, width: notiEnabledRecordUrl, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.addBar(name: (String(notiViewNorPath.suffix(5)) + "ack_blac" + String(app_mKey.prefix(5)))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.dataWith(color: .outsideBecomeColor(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(dataBackgroundPartyName)).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.statusTo(showMsg: String(bytes: appFilterContent.map{socialAdd(single: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.statusTo(showMsg: (String(userBirthdayText) + String(main_viewName.suffix(4)) + "lect " + String(notiSucceedName)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.statusTo(showMsg: (String(const_valueCornerData.suffix(4)) + "se s" + dataRankName.replacingOccurrences(of: "layer", with: "c") + " an o" + String(show_equalId)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = MinutiaRepresentable(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.response(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: ModelHeadTransformable = dataArr[index] as! ModelHeadTransformable
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(omit(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(windowNotification(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(doClick(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: user_touchTitle.reversed(), encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(hadithClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(kSizeText.prefix(6)) + " objec" + String(showFrameName.prefix(3))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(tableMake), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(box), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.text = (String(main_userKey) + String(dataKitMakeContent) + String(const_theIndexName)).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.constraintWindow(colors: [UIColor(hex: (user_fillBottomName.replacingOccurrences(of: "color", with: "5")))!.cgColor, UIColor(hex: (constAppName.replacingOccurrences(of: "view", with: "F")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.pingfangCenter(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(dataNameCenterMsg.suffix(7))).localized, for: .normal)
...
extension NumberDataSource {
    ...
    @objc func quantityerval() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: main_versionEnterTimeStr, width: notiEnabledRecordUrl, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func dismissBy() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: main_versionEnterTimeStr - self.contentHeight, width: notiEnabledRecordUrl, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func hadithClick() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = MinutiaRepresentable(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.response(dataType: dataType)
    ...
    @objc func tableMake() {
        ...
        meneView = SprechgesangThen(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func box() {
        //: dismissView()
        quantityerval()
        //: ManageressThen.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        ManageressThen.share.digitiserChangeType(webViewType: .luckyBlindBox)
    }
...
extension NumberDataSource {
    ...
    func bringHomeWith(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.response(dataType: self.currType) as! [ModelHeadTransformable]
            // 找到当前背包礼物索引，更新数量
            ...
            ControlGiftManager.share.lagniappe(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.length(force: true)
        }
    }
}

// MARK: - ControlReplyViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension NumberDataSource: ControlReplyViewDelegate {
    ...
    func honkyTonkModel(model: ResistanceReactiveCompatible) {
        ...
        seleteObjectBtn.setTitle((String(appModelPath) + noti_sessionMsg.replacingOccurrences(of: "message", with: "le") + " %@ > ").fast(model.nickname), for: .normal)
    }
    ...
    func generate() {
        ...
        if model.nickname == (String(showHomeId) + String(const_cameraFormat)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! ResistanceReactiveCompatible
    ...
    func statusShow(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(appPlayerFormat.prefix(5)) + "deta" + app_fileTitle.replacingOccurrences(of: "at", with: "il") + " des" + userPopMessage.replacingOccurrences(of: "data", with: "ri") + String(const_requestOffMsg.prefix(5))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension NumberDataSource: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func response(dataType: MinutiaRepresentable) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return ControlGiftManager.share.humanFace(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func wallItems() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return ControlGiftManager.share.withView()
    }
    ...
    func makeDown(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == TradingCardVarArg.myStery.rawValue)
        }
        ...
        hotGiftLayout.hotDataArr = response(dataType: .Hot)
        //: hotGiftLayout.vipDataArr = getGiftData(dataType: .Vip)
        hotGiftLayout.vipDataArr = response(dataType: .Vip)
        //: hotGiftLayout.bagsDataArr = getGiftData(dataType: .Bags)
        hotGiftLayout.bagsDataArr = response(dataType: .Bags)
    ...
    @objc fileprivate func omit(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (show_nameContent.capitalized)
            //: } else {
        } else {
    ...
    @objc func doClick(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: main_versionEnterTimeStr - CGFloat(keyborHeight) - 44, width: notiEnabledRecordUrl, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func windowNotification(notification _: NSNotification) {
    ...
    @objc func themeBy() {
        //: let payWinType = RegularBeginDecisionMakerAppManager.share.appUserConfigMode.payWinType
        let payWinType = RegularBeginDecisionMakerAppManager.share.appUserConfigMode.payWinType
        //: if payWinType == 1 {
    ...
    func cutGiftField() {
        ...
        let sendingItems = wallItems()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(unwished(index: i))
//            let giftNumArrModel: BeautyGiftHandyJSON = sendingItems[i] as! BeautyGiftHandyJSON
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(show_colorAspectPageId.prefix(5)) + dataGirlPath.replacingOccurrences(of: "head", with: "m")).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.SpectaclesConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = DumpViewDelegate.loadName(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func clickNum() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? TantamountView
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.bringForthTo(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = MinutiaRepresentable(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = response(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = (String(dataNamePath))
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TantamountView
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = MinutiaRepresentable(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = response(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: ModelHeadTransformable = dataArr[indexPath.row] as! ModelHeadTransformable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.indexLargess(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.describe(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = MinutiaRepresentable(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = response(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == TradingCardVarArg.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == TradingCardVarArg.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == TradingCardVarArg.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                searchedName(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = positionSize(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = comeOn(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            searchedName(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: TantamountView = giftSelectedModel.lastHotCell as! TantamountView
                //: cell.setChecked(checked: false)
                cell.describe(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: TantamountView = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TantamountView
            //: currentCell.setChecked(checked: true)
            currentCell.describe(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.take(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.response(dataType: self.currType)
    ...
    func length(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + notiEnabledRecordUrl
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < notiEnabledRecordUrl ? notiEnabledRecordUrl : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / notiEnabledRecordUrl - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(notiEnabledRecordUrl) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = MinutiaRepresentable.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = ControlGiftManager.share.queryFront(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.deadlineAnimate(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && RegularBeginDecisionMakerAppManager.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == MinutiaRepresentable.Hot && self.style == .normal && RegularBeginDecisionMakerAppManager.share.loginUserMode.sex == ScoreScalarLiteral.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == TradingCardVarArg.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                statusShow(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func party() {
        ...
        self.giftSelectedModel = ViewVideoModelType()
...
extension NumberDataSource: ClickViewDelegate {
    ...
    func searchedName(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.addView(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.tableTitle(view: self.window!)
    ...
    func unwished(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: BeautyGiftHandyJSON = sendingItems[index] as! BeautyGiftHandyJSON
    ...
    func positionSize(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< wallItems().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: BeautyGiftHandyJSON = wallItems()[i] as! BeautyGiftHandyJSON
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func comeOn(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > wallItems().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension NumberDataSource {
    ...
    private func delaySubviews() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: notiEnabledRecordUrl, height: main_versionEnterTimeStr - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(quantityerval)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(data_useMessage)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(notiEnabledRecordUrl)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(notiEnabledRecordUrl - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(constWarnMessage)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(user_lineId)
        }
    ...
    private func pokeAtShow() {
        //: RegularBeginDecisionMakerAppManager.share.loginUserMode.rx
        RegularBeginDecisionMakerAppManager.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(app_tingStr)))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.makeDown(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        ControlGiftManager.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(constFrameMessage.suffix(8)) + String(show_pathUrl.suffix(3))))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                ControlGiftManager.share.behindReloadMessage(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: RegularBeginDecisionMakerAppManager.share.loginUserMode.mf_coin)
                    self.makeDown(needReload: true, mf_coin: RegularBeginDecisionMakerAppManager.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
