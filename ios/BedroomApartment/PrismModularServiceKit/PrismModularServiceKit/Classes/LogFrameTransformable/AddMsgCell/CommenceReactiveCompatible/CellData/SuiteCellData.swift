...
/*: _" :*/
fileprivate let constModelTitle:String = "_"

/*: ".png" :*/
fileprivate let constTimeData:String = ".pngmake view result model make"
...
//: @objcMembers public class SuiteCellData: TalkingChatMsgBaseCellData {
@objcMembers public class SuiteCellData: CompartmentCellData {
    ...
    override public var msgModel: ClickBottomNameTheoryModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.imageAccount(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func addAcross(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(show_barId)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + RegularBeginDecisionMakerAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + RegularBeginDecisionMakerAppManager.share.loginUserMode.userID + (String(constTimeData.prefix(4)))
