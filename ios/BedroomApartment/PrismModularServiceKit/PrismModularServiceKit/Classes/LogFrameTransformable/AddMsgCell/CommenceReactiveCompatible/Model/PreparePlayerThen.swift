...
@objcMembers class PreparePlayerThen: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: SizeSuiteHandyJSON?
    //: var gift: TalkingMsgGiftModel?
    var gift: ToMeasurable?
    //: var user: TalkingMsgUserModel?
    var user: EmbedMeasurable?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: VideoViewHandyJSON?
...
class SizeSuiteHandyJSON: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class EmbedMeasurable: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class VideoViewHandyJSON: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class ToMeasurable: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
