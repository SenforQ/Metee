...
@property (nonatomic, strong) AlongModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) YankModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ReplyModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) CurrentModel *wantGift; /// 想要礼物
...
@interface AlongModel : JSONModel
...
@interface DigitizerModel : JSONModel
...
@interface LiveSuccessModel : JSONModel
...
@interface ByTipsModel : JSONModel
...
@interface MinutiaModel : JSONModel
...
@property (nonatomic, strong) JumpModel *renderData;
