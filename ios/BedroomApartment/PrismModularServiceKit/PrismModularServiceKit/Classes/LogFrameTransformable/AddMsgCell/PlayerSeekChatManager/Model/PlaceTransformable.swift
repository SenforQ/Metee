...
let data_partyDevicePath = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let kVideoStr = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let show_keyTitle = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct PlaceTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
