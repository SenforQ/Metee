...
fileprivate let notiParaLabelFormat:[UInt8] = [0x5,0x2,0x5,0x18,0x44,0xf,0x3,0x8,0x9,0x1e,0x56,0x45,0x4c,0x4,0xd,0x1f,0x4c,0x2,0x3,0x18,0x4c,0xe,0x9,0x9,0x2,0x4c,0x5,0x1,0x1c,0x0,0x9,0x1,0x9,0x2,0x18,0x9,0x8]

/*: "icon_mini_voice_end" :*/
fileprivate let app_labId:[Character] = ["i","c","o","n","_","m"]
fileprivate let userIconText:[Character] = ["i","n","i","_","v","o","i","c","e","_","e","n","d"]

/*: "#F95151" :*/
fileprivate let const_arrayMessage:String = "#F95151max self data"

/*: "End of call" :*/
fileprivate let show_sizeValue:String = "End empty show content make video"
fileprivate let dataImageId:[Character] = ["l"]

/*: "img_home_shadow_icon" :*/
fileprivate let show_mainUrl:String = "img_hovar guard self define"
fileprivate let appDataId:[Character] = ["h","a"]
fileprivate let main_nameValue:String = "any datadow_icon"
...
class VisualCommunicationReactiveCompatible: SightThen {
	var imageOff: Bool = false
	var byCoverSum: Int = 9
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiParaLabelFormat.map{$0^108}, encoding: .utf8)!)
    }
    ...
    override func expose() {
        ...
        super.expose()
            ...
            if (desLab.intrinsicContentSize.height == 213.04) && (desLab.layer.masksToBounds != false) {
            ...
            var countMessage = pointAnimView.isPlayAnimation
            countMessage = false
            if countMessage != self.imageOff {
                self.imageOff = countMessage
            }
            
            return self.imageOff
            }
            countMessage.milkNumber = { [self] conferenceTotal in
            self.byCoverSum = conferenceTotal
            
            return self.byCoverSum
            }
            countMessage.photoDictionary = { [self] tapOfCameraDictionary in
            self.startDictionary = tapOfCameraDictionary
            ...
            return value
                ...
                desLab.addSubview(countMessage)
            }
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.addBar(name: (String(app_labId) + String(userIconText)))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(const_arrayMessage.prefix(7))))
        ...
        lab.text = (String(show_sizeValue.prefix(4)) + "of cal" + String(dataImageId)).localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.addBar(name: (String(show_mainUrl.prefix(6)) + "me_s" + String(appDataId) + String(main_nameValue.suffix(8))))
...
extension VisualCommunicationReactiveCompatible {
    /// 构建视频小窗口
    //: static func buildVideoMiniView() -> TalkingVideoMiniView {
    static func notTotaleractionLocation() -> VisualCommunicationReactiveCompatible {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = VisualCommunicationReactiveCompatible(frame: .zero)
    ...
    func ingredientFull(point: String) {
