...
fileprivate let data_airCurrentKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let main_toText:String = "icon_ldetail model equal"
fileprivate let user_pendingFormat:[Character] = ["n"]

/*: "OK" :*/
fileprivate let mainQuantityKey:String = "Oview"
...
class DetailThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_airCurrentKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.addBar(name: (String(main_toText.prefix(6)) + "ivetc_war" + String(user_pendingFormat)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = RegularBeginDecisionMakerAppManager.share.appUserConfigMode.blockCameraPopupContent
        lab.text = RegularBeginDecisionMakerAppManager.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
...
extension DetailThen {
    ...
    private func invitationConstraint() {
