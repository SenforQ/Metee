...
fileprivate let app_contentId:[UInt8] = [0x61,0x66,0x61,0x7c,0x20,0x6b,0x67,0x6c,0x6d,0x7a,0x32,0x21,0x28,0x60,0x69,0x7b,0x28,0x66,0x67,0x7c,0x28,0x6a,0x6d,0x6d,0x66,0x28,0x61,0x65,0x78,0x64,0x6d,0x65,0x6d,0x66,0x7c,0x6d,0x6c]

private func hiddenLow(model num: UInt8) -> UInt8 {
    return num ^ 8
}

/*: "bg_vip" :*/
fileprivate let data_showPath:String = "B"
fileprivate let showPurpleId:String = "any else varg_vip"

/*: "OK" :*/
fileprivate let main_infoTitle:String = "sendK"
...
class PlayReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_contentId.map{hiddenLow(model: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.addBar(name: (data_showPath.lowercased() + String(showPurpleId.suffix(5))))
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(everyLegalRight), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PlayReactiveCompatible {
    ...
    @objc private func everyLegalRight() {
        //: callBlock?(self.type)
        callBlock?(self.type)
        //: dismiss()
        upValue()
