...
/******************************************************************************
 *
 *  本文件声明了 QuantityeractionReactiveCompatible 类。
 ...
 * 消息翻译状态
 */
//: @objc public enum DispensationNumeric: UInt {
@objc public enum DispensationNumeric: UInt {
...
@objc public enum TrackScalar: UInt {
...
// MARK: - QuantityeractionReactiveCompatible

/**
 * 【模块名称】QuantityeractionReactiveCompatible
 ...
 */
//: @objcMembers public class QuantityeractionReactiveCompatible: TCommonCellData {
@objcMembers public class QuantityeractionReactiveCompatible: AggregationThen {
    ...
    public var direction: TrackScalar = .MsgDirectionIncoming
    ...
    //: public var translateStatus: DispensationNumeric = .MsgTranslate_init
    public var translateStatus: DispensationNumeric = .MsgTranslate_init
    ...
    public var msgModel: ClickBottomNameTheoryModel = ClickBottomNameTheoryModel()
    ...
    public var cellLayout: LogCellLayout!
    ...
    public init(direction: TrackScalar) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.quadrateComment()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = LogCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = LogCellLayout(isIncomming: false)
    ...
    public override func fromWidth(_ width: CGFloat) -> CGFloat {
