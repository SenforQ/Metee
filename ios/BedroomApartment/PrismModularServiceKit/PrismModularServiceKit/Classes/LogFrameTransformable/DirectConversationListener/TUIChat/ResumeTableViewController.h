 ...
 *
 *  AttachTotal 协议和 ResumeTableViewController 类。
 *  ResumeTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 ResumeTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class ResumeTableViewController;
//: @class EqualGlobalView;
@class EqualGlobalView;
//: @class QuantityeractionReactiveCompatible;
@class QuantityeractionReactiveCompatible;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
- (void)didTapInMessageController:(ResumeTableViewController *)controller;
...
- (void)didHideMenuInMessageController:(ResumeTableViewController *)controller;
...
- (BOOL)messageController:(ResumeTableViewController *)controller willShowMenuInCell:(UIView *)view;
 ...
 */
//: - (QuantityeractionReactiveCompatible *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (QuantityeractionReactiveCompatible *)messageController:(ResumeTableViewController *)controller onNewMessage:(V2TIMMessage *)data;
 ...
 */
//: - (EqualGlobalView *)messageController:(TUIMessageController *)controller onShowMessageData:(QuantityeractionReactiveCompatible *)data;
- (EqualGlobalView *)messageController:(ResumeTableViewController *)controller onShowMessageData:(QuantityeractionReactiveCompatible *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(EqualGlobalView *)cell;
- (void)messageController:(ResumeTableViewController *)controller onSelectMessageAvatar:(EqualGlobalView *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(EqualGlobalView *)cell;
- (void)messageController:(ResumeTableViewController *)controller onSelectMessageContent:(EqualGlobalView *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(QuantityeractionReactiveCompatible *)data;
- (void)messageController:(ResumeTableViewController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(QuantityeractionReactiveCompatible *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(EqualGlobalView *)cell;
- (void)messageController:(ResumeTableViewController *)controller onRetryMessageContent:(EqualGlobalView *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(QuantityeractionReactiveCompatible *)cellData;
- (void)messageController:(ResumeTableViewController *)controller onReplyMessage:(QuantityeractionReactiveCompatible *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(QuantityeractionReactiveCompatible *)cellData;
- (void)messageController:(ResumeTableViewController *)controller onClickReplyMessage:(QuantityeractionReactiveCompatible *)cellData;
...
/**
 * 腾讯云 TUIKit
 *  【模块名称】ResumeTableViewController
...
@interface ResumeTableViewController : UITableViewController

/**
 *  执行 AttachTotal 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<AttachTotal> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<QuantityeractionReactiveCompatible *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成QuantityeractionReactiveCompatible
 */
