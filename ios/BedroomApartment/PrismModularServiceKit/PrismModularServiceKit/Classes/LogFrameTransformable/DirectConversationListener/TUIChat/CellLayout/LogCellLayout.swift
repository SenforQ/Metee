...
@objcMembers public class LogCellLayout: NSObject {
    ...
    class func mail() -> LogCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = LogCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func eventText() -> LogCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = LogCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func anTag() -> LogCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = LogCellLayout.init(isIncomming: false)
    ...
    class func centerPicture() -> LogCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = LogCellLayout.init(isIncomming: true)
        //: return layout
        return layout
