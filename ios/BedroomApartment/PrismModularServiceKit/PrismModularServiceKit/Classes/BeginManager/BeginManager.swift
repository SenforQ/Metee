...
/*: "&sr=6" :*/
fileprivate let kLeadingMakeOfTitle:[Character] = ["&","s","r","=","6"]
...
enum ActionDataTitle: String, CaseIterable {
...
class BeginManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func taphouse(urlType: ViewSendable) -> String {
        //: var url = RegularBeginDecisionMakerAppManager.share.appConfigMode.urlH5Domain
        var url = RegularBeginDecisionMakerAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(RegularBeginDecisionMakerAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : RegularBeginDecisionMakerAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(RegularBeginDecisionMakerAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : RegularBeginDecisionMakerAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage.appending((String(kLeadingMakeOfTitle)))
            //: url.append(RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(RegularBeginDecisionMakerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
