...
fileprivate let noti_directionMessage:[UInt8] = [0xfe,0xf9,0xfe,0xe3,0xbf,0xf4,0xf8,0xf3,0xf2,0xe5,0xad,0xbe,0xb7,0xff,0xf6,0xe4,0xb7,0xf9,0xf8,0xe3,0xb7,0xf5,0xf2,0xf2,0xf9,0xb7,0xfe,0xfa,0xe7,0xfb,0xf2,0xfa,0xf2,0xf9,0xe3,0xf2,0xf3]

private func appSend(image num: UInt8) -> UInt8 {
    return num ^ 151
}
...
class PriceView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_directionMessage.map{appSend(image: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var progressView: TotalervalControlProgressView = {
        ...
        let v = TotalervalControlProgressView(frame: self.frame, progressBgColor: self.progressBgColor, progressPlayedColor: self.progressPlayedColor, progressCachedColor: self.progressCachedColor)
    ...
    private lazy var panGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(gestureText(gesture:)))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(render(gesture:)))
        //: return v
        return v
        //: }()
    }()
...
extension PriceView {
    ...
    @objc func gestureText(gesture: UIPanGestureRecognizer) {
        // 移动的距离
    ...
    @objc func render(gesture: UIPanGestureRecognizer) {
