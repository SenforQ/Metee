...
// __CLOSE_PRINT__
//
//  ReadPlayReactiveCompatible.swift
//  AbroadTalking
//
...
class ReadPlayReactiveCompatible: UIView {

    //: class func caculateSizeWithText(text: String, size: CGSize, font: UIFont, lineNumber: Int) -> CGSize {
    class func withQuantity(text: String, size: CGSize, font: UIFont, lineNumber: Int) -> CGSize {
        //: let lb = UILabel.init()
        let lb = UILabel.init()
        //: lb.text = text
        lb.text = text
