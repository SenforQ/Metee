...
fileprivate let appDataStr:[UInt8] = [0x66,0x61,0x66,0x7b,0x27,0x6c,0x60,0x6b,0x6a,0x7d,0x35,0x26,0x2f,0x67,0x6e,0x7c,0x2f,0x61,0x60,0x7b,0x2f,0x6d,0x6a,0x6a,0x61,0x2f,0x66,0x62,0x7f,0x63,0x6a,0x62,0x6a,0x61,0x7b,0x6a,0x6b]

private func selfLet(smart num: UInt8) -> UInt8 {
    return num ^ 15
}

/*: "icon_shouye_biaoshi_default" :*/
fileprivate let mainExtraFeatureValue:[Character] = ["i","c","o","n","_","s","h","o","u","y","e","_","b","i","a","o","s","h"]
fileprivate let app_appearPath:String = "i_defaulttitle class size frame container"
...
class FirstViewCell: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appDataStr.map{selfLet(smart: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var authImgV: UIImageView = {
        ...
        v.image = UIImage(named: (String(mainExtraFeatureValue) + String(app_appearPath.prefix(9))))
    ...
    private lazy var nameLab: UILabel = {
        ...
        lab.font = .pingfangCenter(type: .Regular, fontSize: 15)
...
extension FirstViewCell {
    ...
    func cellIndexInfo(_ model: ButtonModelType?) {
        //: guard let model = model else { return }
        guard let model = model else { return }
        //: headImgView.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.placeHolderImage(sex: model.sex))
        headImgView.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.componentTo(sex: model.sex))
