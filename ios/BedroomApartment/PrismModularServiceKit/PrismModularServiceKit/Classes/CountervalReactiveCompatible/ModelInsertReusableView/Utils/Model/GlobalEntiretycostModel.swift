...
//: @objcMembers public class GlobalEntiretycostModel: JSONModel {
@objcMembers public class GlobalEntiretycostModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = SizeExpressionConvertible.Face
...
//: @objc extension GlobalEntiretycostModel {
@objc extension GlobalEntiretycostModel {
    //: func initWith(suiteType: BeautyItemType)-> GlobalEntiretycostModel {
    func upType(suiteType: SizeExpressionConvertible) -> GlobalEntiretycostModel {
        //: let model = GlobalEntiretycostModel.init()
        let model = GlobalEntiretycostModel()
