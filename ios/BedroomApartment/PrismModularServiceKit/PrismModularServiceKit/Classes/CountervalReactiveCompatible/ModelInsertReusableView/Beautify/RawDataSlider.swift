...
/*: "st_slider_thumb" :*/
fileprivate let data_labName:String = "if to curst_slid"
fileprivate let notiTopName:String = "er_thumbthe language title sex"

/*: "init(coder:) has not been implemented" :*/
fileprivate let noti_textTablePath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class RawDataSlider: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.addBar(name: (String(data_labName.suffix(7)) + String(notiTopName.prefix(8))))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_textTablePath.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.pingfangCenter(type: .Regular, fontSize: 12)
...
extension RawDataSlider {
    ...
    func informationView(value: Float) {
