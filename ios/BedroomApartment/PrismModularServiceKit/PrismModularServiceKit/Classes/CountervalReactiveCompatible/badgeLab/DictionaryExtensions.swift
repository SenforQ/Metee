...
extension Dictionary {
    ...
    public static func dictionaryEqual(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func lie(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.dictionaryEqual(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
