...
enum ClickFromTypeMirrorPath: String {
    //: case AppleLogin
...
enum ActionDotTransformable: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum ScoreScalarLiteral: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum SawLogSchemaConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum PercentageComparable: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum TidyRegularSubordinateScalar: Int {
    //: case isOnGoing = 0
...
@objc enum MomentNumberLiteral: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum PlayClickSignedNumeric: Int {
    //: case Unavailable = 0
...
enum IncreaseCellType: CaseIterable {
