...
class MatchDataBase: NSObject {
    ...
    private lazy var rootPath: URL = {
        ...
        let path = cachesDirectory.appendingPathComponent("/match.db")
...
class MatchDataModelBase: Codable, MatchDataProtocol {
